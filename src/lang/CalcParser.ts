...
export class CalcParser extends Parser {
	...
	public program(): ProgramContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (((((_la - 17)) & ~0x1F) === 0 && ((1 << (_la - 17)) & ((1 << (CalcParser.T__16 - 17)) | (1 << (CalcParser.T__19 - 17)) | (1 << (CalcParser.T__22 - 17)) | (1 << (CalcParser.T__24 - 17)) | (1 << (CalcParser.T__27 - 17)) | (1 << (CalcParser.T__29 - 17)) | (1 << (CalcParser.T__30 - 17)) | (1 << (CalcParser.INTEGER_LITERAL - 17)) | (1 << (CalcParser.BOOLEAN_LITERAL - 17)) | (1 << (CalcParser.REAL_LITERAL - 17)) | (1 << (CalcParser.STRING_LITERAL - 17)) | (1 << (CalcParser.IDENTIFIER - 17)))) !== 0)) {
				{
				{
				this.state = 151;
				this.statement();
