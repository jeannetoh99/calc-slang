...
export class CalcParser extends Parser {
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 3:
						...
						_la = this._input.LA(1);
						if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CalcParser.T__11) | (1 << CalcParser.T__12) | (1 << CalcParser.T__13) | (1 << CalcParser.T__14))) !== 0))) {
	...
	public program(): ProgramContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CalcParser.T__7) | (1 << CalcParser.T__27) | (1 << CalcParser.T__30))) !== 0) || ((((_la - 34)) & ~0x1F) === 0 && ((1 << (_la - 34)) & ((1 << (CalcParser.T__33 - 34)) | (1 << (CalcParser.T__36 - 34)) | (1 << (CalcParser.T__39 - 34)) | (1 << (CalcParser.T__41 - 34)) | (1 << (CalcParser.T__42 - 34)) | (1 << (CalcParser.INTEGER_LITERAL - 34)) | (1 << (CalcParser.BOOLEAN_LITERAL - 34)) | (1 << (CalcParser.REAL_LITERAL - 34)) | (1 << (CalcParser.STRING_LITERAL - 34)) | (1 << (CalcParser.UNIT_LITERAL - 34)) | (1 << (CalcParser.NIL - 34)) | (1 << (CalcParser.IDENTIFIER - 34)))) !== 0)) {
				{
				{
				this.state = 195;
				this.statement();
